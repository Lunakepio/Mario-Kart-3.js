    ...
    <>
      <RigidBody
        ...
        onIntersectionEnter={({ other }) => {
          if (other.rigidBodyObject.name === 'player') {
            ...
            setNetworkBananas(
              networkBananas.filter((banana) => banana.id !== id)
            )
          }
        }}
        colliders={false}
      ...
      >
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Banana_Peel_02_-_Default_0'].geometry}
        ...
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Banana_Peel_07_-_Default_0'].geometry}
        ...
        <mesh
          castShadow
          receiveShadow
          geometry={nodes['Banana_Peel_03_-_Default_0'].geometry}
